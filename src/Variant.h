#ifndef UCXX_VARIANT_H
#define UCXX_VARIANT_H

//
// Variant (any-type) implementation
//
...
/**
 * @brief Variant data type container.
 * This class implements a universal container for several predefined data types.
 */
class Variant
{
public:
